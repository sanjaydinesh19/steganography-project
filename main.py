...
def main():
    ...
    key = os.urandom(32)
    msg = b"Steganography is the practice of concealing information within another medium so that the presence of the hidden data is not obvious."
    ...
    embed_payload("input(1024x1024).png", "stego.png", payload)
    recovered_payload = extract_payload("stego.png")
